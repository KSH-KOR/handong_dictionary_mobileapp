...
class ReviseRequestView extends StatefulWidget {
  const ReviseRequestView({Key? key}) : super(key: key);

  @override
  State<ReviseRequestView> createState() => _ReviseRequestViewState();
}

class _ReviseRequestViewState extends State<ReviseRequestView> {
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                height: 48,
                child: RequestButton(
                  snackBarText: '용어 수정 요청이 완료되었습니다.',
                  requestAction: RequestAction.revisementRequest,
